...
class Widgetbebidadia extends StatelessWidget {
  final Bebidasmodels bebida;
  const Widgetbebidadia({super.key, required this.bebida});
            ...
            children: [
                ...
                child: InkWell(
                  onTap: () async {
                    var bebidaCompleta = await Bebidaservice()
                        .buscarBebidaPorNombre(bebida.strDrink);
              ...
              Positioned(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      bebida.strTranslatedstrDrink ?? bebida.strDrink,
